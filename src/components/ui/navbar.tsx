...
export const NavbarItem = forwardRef(function NavbarItem(
  ...
  let classes = clsx(
    ...
    'data-[slot=icon]:*:size-6 data-[slot=icon]:*:shrink-0 data-[slot=icon]:*:fill-primary-blue-900 sm:data-[slot=icon]:*:size-5',
    ...
    // Hover
    'data-[hover]:bg-zinc-950/5 data-[slot=icon]:*:data-[hover]:fill-primary-blue-900',
    // Active
