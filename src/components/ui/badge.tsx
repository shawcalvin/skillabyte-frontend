...
const colors = {
  ...
  orange:
    'bg-primary-orange-500/15 text-primary-orange-700 group-data-[hover]:bg-primary-orange-500/25',
  amber:
  ...
  blue: 'bg-primary-blue-500/15 text-primary-blue-700 group-data-[hover]:bg-primary-blue-500/25',
  indigo:
