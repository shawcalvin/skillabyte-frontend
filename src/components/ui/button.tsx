...
const styles = {
  ...
  colors: {
    ...
    orange: [
      'text-white [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.primary-orange.500)] [--btn-border:theme(colors.primary-orange.600/90%)]',
      '[--btn-icon:theme(colors.primary-orange.300)] data-[active]:[--btn-icon:theme(colors.primary-orange.200)] data-[hover]:[--btn-icon:theme(colors.primary-orange.200)]',
    ],
    amber: [
    ...
    blue: [
      'text-white [--btn-hover-overlay:theme(colors.white/10%)] [--btn-bg:theme(colors.primary-blue.500)] [--btn-border:theme(colors.primary-blue.600/90%)]',
      '[--btn-icon:theme(colors.primary-blue.200)] data-[active]:[--btn-icon:theme(colors.primary-blue.100)] data-[hover]:[--btn-icon:theme(colors.primary-blue.100)]',
    ],
    violet: [
